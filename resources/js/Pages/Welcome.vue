...
<template>
    <nav
        class="sticky z-40 top-0 py-3 bg-background/80 backdrop-blur-lg border-b border-border"
    >
        <div
            class="container flex flex-wrap max-w-screen-2xl items-center justify-between"
        >
    ...
    <main class="mt-12 md:mt-32">
        <div class="container flex flex-col gap-28">
            <div class="flex flex-col gap-7">
                ...
                <p class="max-w-2xl text-lg">
                    Bienvenue dans Crawl Of Gencraft, une aventure textuelle où
                    chaque salle, chaque monstre et chaque trésor sont générés
                    en temps réel par une intelligence artificielle. Chaque
                    partie est différente, chaque choix compte.
                </p>
            </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <img
                    loading="lazy"
                    alt="Entrée d'un donjon à l'aspect inquiétant"
                ...
                />
                <div
                    class="flex flex-col justify-between gap-10 rounded-2xl bg-muted p-10"
                >
                    <p class="text-sm text-muted-foreground">NOTRE VISION</p>
                    <p class="text-lg font-medium">
                        Notre objectif est de créer des aventures infinies,
                        toujours surprenantes. Grâce à l'IA, chaque donjon est
                        une nouvelle histoire à raconter, à explorer et à
                        conquérir.
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-6 md:gap-20">
                <div class="max-w-2xl">
                    ...
                    <p class="text-muted-foreground">
                        Crawl Of Gencraft vous offre une expérience renouvelée à
                        chaque partie. L'IA génère des salles, des ennemis et
                        des trésors selon vos actions. Êtes-vous prêt à
                        affronter l'inconnu ?
                    </p>
                </div>
                ...
                <div class="grid gap-10 md:grid-cols-3">
                    <div class="flex flex-col">
                        <div
                            class="mb-5 flex size-12 items-center justify-center rounded-2xl bg-accent"
                        >
                            <Files class="size-5" />
                        </div>
                        ...
                        <p class="text-muted-foreground">
                            Aucun donjon ne ressemble à un autre. Chaque salle
                            est unique, générée en fonction de vos choix et de
                            l'univers de jeu. Explorez sans cesse des terres
                            inconnues.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-muted-foreground">
                            Vos décisions influencent l'histoire et les
                            événements. Chaque action, que ce soit combattre ou
                            fuir, change la trajectoire de votre exploration.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-muted-foreground">
                            Plongez dans un monde où l'IA vous guide, mais où
                            vous gardez le contrôle. Le donjon évolue en temps
                            réel en fonction de votre progression.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <footer class="mt-32 mb-12">
            <div class="container">
                <div
                    class="flex flex-col items-center rounded-lg bg-accent p-8 text-center md:rounded-xl lg:p-16"
                >
                    <h3
                        class="mb-3 max-w-3xl text-2xl font-semibold md:mb-4 md:text-4xl lg:mb-6"
                    >
                        Rejoignez l'aventure de Crawl of Gencraft
                    </h3>
                    <p class="mb-8 max-w-3xl text-muted-foreground lg:text-lg">
                        Prenez part à une expérience immersive unique et créez
                        votre propre chemin dans le donjon. Inscrivez-vous
                        maintenant et préparez-vous pour l'aventure.
                    </p>
                    <div
